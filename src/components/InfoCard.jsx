...
export default function InfoCard() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-sm bg-gray-100 border border-gray-200 rounded-lg shadow-md hover:shadow-asiseg-gray hover:transition-shadow subpixel-antialiased overflow-hidden">
          {/* dark:bg-gray-800 dark:border-gray-700 */}
          <img
            className="max-h-72 w-full object-cover object-center rounded-t-lg "
          ...
          <div className="p-5">
            <h5 className="mb-2 text-xl font-semibold tracking-tight text-gray-900 text-ellipsis overflow-hidden line-clamp-2">
              {/* dark:text-white */}
              Noteworthy technology acquisitions 2021. Noteworthy technology
              acquisitions 2021
            </h5>

            <p className="p-car-text mb-3 font-normal text-gray-700  dark:text-gray-400 text-ellipsis overflow-hidden line-clamp-3">
